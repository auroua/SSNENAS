...
def get_predictor(checkpoint=None, ignore_last=False, num_features=0,
                  num_layers=2, num_hidden=32, dropout_ratio=0, weight_init='thomas', bias_init='thomas',
                  binary_classifier=False, augments=0):
    predictor = GCN(
