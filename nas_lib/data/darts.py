from .darts_api.arch_darts import ArchDarts
import numpy as np
from .darts_api.darts_neuralnet import DartsCifar10NeuralNet
...
class DataSetDarts:
    ...
    def assemble_graph_from_single_arch(self, arch_info):
