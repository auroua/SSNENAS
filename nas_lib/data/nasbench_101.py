from configs import tf_records_path_108
from nasbench import api
from nas_lib.data.nasbench_101_cell import Cell
import numpy as np
...
class NASBench101:
    ...
    def mutate_arch(self, arch, encode_paths=True, mutation_rate=1.0, algo_name='bananas', require_distance=False,
    ...
    def generate_data_with_fix_edit_distance(self, arch, edit_dist, candidate_num, data):
        return Cell(**arch).mutate_edit_distance(self.nasbench, edit_dist, candidate_num, data)

    def generate_candidates_fix_edit_distance(self,
                                              data,
                                              edit_dist,
                                              encode_paths=True,
                                              deterministic_loss=True,
    ...
    def generate_all_archs(self):
        ...
        return total_archs_list, total_archs_filtered_list