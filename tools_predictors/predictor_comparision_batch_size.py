...
from configs import nas_bench_101_all_data, ss_ccl_nasbench_10k, ss_ccl_nasbench_40k, ss_ccl_nasbench_70k, \
    ss_ccl_nasbench_100k, ss_ccl_nasbench_140k
import math
    ...
    if args.search_space == 'nasbench_101':
        ...
        if not args.load_dir:
            args.load_dir = [
                ...
                ss_ccl_nasbench_40k,
                ss_ccl_nasbench_70k,
                ss_ccl_nasbench_100k,
                ss_ccl_nasbench_140k
            ]
    else:
